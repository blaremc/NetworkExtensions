...
{
    public partial class Avenue6LBusCenterBikeBuilderBeforeEndNode : Activable, IMultiNetInfoBuilderPart
    {
        public int Order { get { return 25; } }

        public string BasedPrefabName { get { return NetInfos.Vanilla.ONEWAY_2L; } }
        public string Name { get { return "Avenue6LBusCenterBikeBuilderBeforeEndNode"; } }
        ...
        public IEnumerable<IMenuItemBuilder> MenuItemBuilders
        {
            get
            {
                yield return new MenuItemBuilder
                {
                    ...
                    UIOrder = 20,
                    Name = "Avenue6LBusCenterBikeBuilderBeforeEndNode",
                    ...
                    ThumbnailsPath = @"Roads\WideAvenues\Avenue6LBusCenterBike\Special\beforeendnode.png",
                ...
                yield return new MenuItemBuilder
                {
                    UICategory = RExExtendedMenus.ROADS_WIDE,
                    UIOrder = 21,
                    Name = "Avenue6LBusCenterBikeBuilderBeforeEndNode Decoration Grass",
                    ...
                    ThumbnailsPath = @"Roads\WideAvenues\Avenue6LBusCenterBike\Special\beforeendnode_grass.png",
                    InfoTooltipPath = @"Roads\WideAvenues\Avenue6LBusCenterBike\infotooltip.png"
                };
                yield return new MenuItemBuilder
                {
                    UICategory = RExExtendedMenus.ROADS_WIDE,
                    UIOrder = 22,
                    Name = "Avenue6LBusCenterBikeBuilderBeforeEndNode Decoration Trees",
                    DisplayName = "Four-Devided-Lane Avenue With 4 Parking",
                    Description = "A basic two lane road with a grass median, trees and with parkings spaces. Supports local traffic.",
                    ThumbnailsPath = @"Roads\WideAvenues\Avenue6LBusCenterBike\Special\beforeendnode_trees.png",
                    InfoTooltipPath = @"Roads\WideAvenues\Avenue6LBusCenterBike\infotooltip.png"
                };
            }
        ...
        public void BuildUp(NetInfo info, NetInfoVersion version)
        {
            ...
            // 3DModeling            //
            ///////////////////////////
            info.Setup40m3mSW1mB2x4mMdnSpecialMesh(version, SpecailSegments.BeforeEndNode);
            ...
            if (streetLight != null)
            {
                ...
                streetLight.m_prop = Prefabs.Find<PropInfo>("New Street Light Small Road");
           ...
           // pedLanes.Add(leftPed);
            ...
            for (int i = 0; i < info.m_segments.Length; i++)
            {
                 ...
                 invertMe = (((info.m_segments[i].m_backwardForbidden & NetSegment.Flags.Invert) == 0));
            }
            Debug.Log("invertMe");
            Debug.Log(invertMe);
