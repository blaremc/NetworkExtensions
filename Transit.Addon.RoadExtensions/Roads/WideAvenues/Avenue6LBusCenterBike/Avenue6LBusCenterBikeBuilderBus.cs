...
{
    public partial class Avenue6LBusCenterBikeBuilderBus : Activable, IMultiNetInfoBuilderPart
    {
        public int Order { get { return 25; } }

        public string BasedPrefabName { get { return NetInfos.Vanilla.ONEWAY_2L; } }
        public string Name { get { return "WideAvenue6LBusCenterBikeBus"; } }
        ...
        public IEnumerable<IMenuItemBuilder> MenuItemBuilders
        {
            get
            {
                yield return new MenuItemBuilder
                {
                    ...
                    UIOrder = 20,
                    Name = "WideAvenue6LBusCenterBikeBus",
                    ...
                    ThumbnailsPath = @"Roads\WideAvenues\Avenue6LBusCenterBike\Special\thumbnails_bus.png",
        ...
        public void BuildUp(NetInfo info, NetInfoVersion version)
        {
            ...
            // 3DModeling            //
            ///////////////////////////
            info.Setup40m3mSW1mB2x4mMdnSpecialMesh(version , SpecailSegments.BusStation);
...
/*
            ...
            Debug.Log("+rightPedLane+");

            for (var i = 0; i < rightPedLane.m_laneProps.m_props.Count(); i++)
            {
                Debug.Log(rightPedLane.m_laneProps.m_props[i].m_prop.name.ToLower());
            ...
            */
            ...
            centerLane1.m_position = -5f;
            centerLane2.m_position = 5f;
            ...
            leftPedLaneProps.ForEach(prop =>
            {
                ...
                if (prop.m_prop.name.ToLower().Contains("traffic"))
                {
                  ...
                  //  centerLane2PedLaneProps.AddProp(prop.ShallowClone());
                    ...
                    centerLane1PedLaneProps.AddProp(traff);
                }
            });
